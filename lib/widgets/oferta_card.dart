            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  // 🤖 BLOQUE DE IA: Se muestra cuando hay análisis listo y el usuario es Premium
                  if (item['ia_puntuacion'] != null && item['ia_puntuacion']!.isNotEmpty) ...[
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text('Análisis de Chollo IA: ${item['ia_puntuacion']}/10', 
                                style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
                            ],
                          ),
                          const SizedBox(height: 4),
                          Text(item['ia_analisis'] ?? '', 
